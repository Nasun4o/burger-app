...
class BurgerBuilder extends Component {
    ...
    // componentDidMount () {
    //     axios.get('https://burger-app-59992-default-rtdb.firebaseio.com/ingredients.json')
    //     .then(response => {
...
//By this we change the state of our application and again passit as a props
